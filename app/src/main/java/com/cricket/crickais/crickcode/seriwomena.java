 ...
 */
public class seriwomena extends Fragment {
    ...
    private DatabaseReference root = db.getReference("Archive").child("Women");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.seriwomena, container, false);
