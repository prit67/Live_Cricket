...
public class moreview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_moreview);

        fsc=findViewById(R.id.fsc);
        ssc=findViewById(R.id.ssc);
        pts=findViewById(R.id.pts);
        icon1=findViewById(R.id.icon1);
        ssc1=findViewById(R.id.ssc1);
        team10 = findViewById(R.id.team10);
        team101 = findViewById(R.id.team101);
        team102 = findViewById(R.id.team102);
        team1012 = findViewById(R.id.team1012);
        team10121=findViewById(R.id.team10121);
        team103 = findViewById(R.id.team103);
        ptm=findViewById(R.id.ptm);
        bar=findViewById(R.id.bar);
        start=findViewById(R.id.start);
        plr=findViewById(R.id.plr);
        icon=findViewById(R.id.icon);
        team20111=findViewById(R.id.team20111);
        team20122=findViewById(R.id.team20122);
        ...
        team2011 = findViewById(R.id.team2011);
        team2012 = findViewById(R.id.team2012);
        team2013 = findViewById(R.id.team2013);
        log=findViewById(R.id.log);
        tabllayout01=findViewById(R.id.tabllayout01);
        tabllayout=findViewById(R.id.tabllayout);

        comment = findViewById(R.id.comment);
        list_view = findViewById(R.id.list_view);
        list_view1 = findViewById(R.id.list_view1);
        list_view_second=findViewById(R.id.list_view_second);
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    if (moreview.this != null) {
                        moreview.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                songs.clear();
                                songs1.clear();
                                ...
                                comment.setLayoutManager(new LinearLayoutManager(moreview.this, LinearLayoutManager.VERTICAL, true));
                                cmntadapt = new cmntadaptwq(moreview.this, songs);
                                comment.setAdapter(cmntadapt);

                                list_view.setLayoutManager(new LinearLayoutManager(moreview.this, LinearLayoutManager.VERTICAL, true));
                                adapterbatting = new Adapterbatting(moreview.this, songs1);
                                list_view.setAdapter(adapterbatting);

                                list_view_second.setLayoutManager(new LinearLayoutManager(moreview.this, LinearLayoutManager.VERTICAL, true));
                                adapterbatting1 = new Adapterbatting(moreview.this, songssec);
                                list_view_second.setAdapter(adapterbatting1);

                                list_view1.setLayoutManager(new LinearLayoutManager(moreview.this, LinearLayoutManager.VERTICAL, true));
                                adapterbowling = new Adapterbowling(moreview.this, bowlers);
