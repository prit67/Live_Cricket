 ...
 */
public class seridoma extends Fragment {
    ...
    private DatabaseReference root = db.getReference("Archive").child("Domestic");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.seridoma, container, false);
