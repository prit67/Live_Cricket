 ...
 */
public class seridom extends Fragment {
    ...
    private DatabaseReference root = db.getReference("Series").child("Domestic");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.seridom, container, false);
