 ...
 */
public class seri extends Fragment {
    ...
    private DatabaseReference root = db.getReference("Series").child("International");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.seri, container, false);
