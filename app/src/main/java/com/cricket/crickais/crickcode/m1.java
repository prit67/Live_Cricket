        ...
        databaseReference1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Request request = new Request.Builder()
                        .url("https://cricket.sportmonks.com/api/v2.0/fixtures?api_token=lhkyue6be0nJnQUrDcqEEVWVRYshXvjLJyNcLNrat9Di7C5qFRLquPXjieDt"+token+"&include=runs,tosswon,league,localteam,visitorteam,stage&filter[stage_id]="+stage)
                        .get().build();
