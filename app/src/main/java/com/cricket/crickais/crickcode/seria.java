 ...
 */
public class seria extends Fragment {
    ...
    private DatabaseReference root = db.getReference("Archive").child("International");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.seria, container, false);
