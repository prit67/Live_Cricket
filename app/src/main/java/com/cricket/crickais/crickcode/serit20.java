 ...
 */
public class serit20 extends Fragment {
    ...
    private DatabaseReference root = db.getReference("Series").child("T20");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.serit20, container, false);
